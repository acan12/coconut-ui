package app.coconut.ui.com.beelabs.ui.camera.view;
...
public class ViewIDCardCoco extends LinearLayout {
    ...
    public static void setMarginTop(int marginTop) {
        ViewIDCardCoco.marginTop = marginTop;
    }

    public ViewIDCardCoco(Context context) {
        super(context);
    }

    public ViewIDCardCoco(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewIDCardCoco(Context context, AttributeSet attrs, int defStyle) {
