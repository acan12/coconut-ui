//package app.coconut.ui.com.beelabs.ui.component.calendar.listener;
//
...
//
//    private static View prevDayClicked;
...
//        if (prevDayClicked != null) {
//            prevDayClicked.findViewById(R.id.day_content).setBackgroundColor(prevDayClicked.getResources().getColor(R.color.color_white));
//            prevDayClicked = null;
//        }
//    }
//
...
//        if (prevDayClicked != null)
//            prevDayClicked.findViewById(R.id.day_content).setBackgroundColor(prevDayClicked.getResources().getColor(R.color.color_white));
//        view.findViewById(R.id.day_content).setBackground(view.getResources().getDrawable(R.drawable.border_rectangle_yellow));
//
//        this.prevDayClicked = view;
//
