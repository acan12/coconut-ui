//package app.coconut.ui.com.beelabs.ui.component.calendar.adapters;
//
...
//
//import app.coconut.ui.com.beelabs.ui.component.calendar.view.CalendarPlayScheduleView;
//
///**
...
//        }
//
//        TextView dayLabel = (TextView) view.findViewById(com.applandeo.materialcalendarview.R.id.dayLabel);
//        ImageView dayIcon = (ImageView) view.findViewById(com.applandeo.materialcalendarview.R.id.dayIcon);
//
...
//
////        FontUtil.fontFace(com.applandeo.materialcalendarview.R.id.dayLabel, FontUtil.GELPEN, view);
//        return view;
//    }
//
...
//                    Typeface.NORMAL, com.applandeo.materialcalendarview.R.drawable.background_transparent);
//            return;
//        }
//
...
//        return mCalendarProperties.getCalendarType() != CalendarPlayScheduleView.CLASSIC && day.get(Calendar.MONTH) == mPageMonth
...
//        if (mCalendarProperties.getEventDays() == null || mCalendarProperties.getCalendarType() != CalendarPlayScheduleView.CLASSIC) {
